        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="class-management.php"><i class="menu-icon fa fa-calendar"></i>Daftar Kelas</a>
                        <a href="student-management.php"><i class="menu-icon fa fa-users"></i>Daftar Mahasiswa</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">
                                                ...
                                                ?></span></div>
                                            <div class="stat-heading">Jumlah Jurusan</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
